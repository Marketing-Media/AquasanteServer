...
$catalogue = new MessageCatalogue('fr-CA', array (
  ...
  'ShopThemeGlobal' => 
  array (
    'Why shop [1]with us?[/1]' => 'POURQUOI MAGASINER CHEZ [1]PRODUITS AQUA SANTÉ ?[/1]',
    'We offer free shipping on all new Berkey Systems' => 'Nous offrons la livraison gratuite sur tous les systèmes Berkey®',
    'WE ARE CANADIAN' => 'ENTREPRISE CANADIENNE',
    'Orders ship from Canada.[1] No hidden shipping or import fees' => 'Les commandes sont expédiées à 
partir du Canada[1] aucuns frais cachés',
    'WE ARE WATER EXPERTS' => 'EXPERTISE RECONNUE',
    'We have been providing healthy water solutions to Canadians since 2010' => 'Nous sommes reconnus pour notre expertise en matière d’eau et de santé',
    'About Us' => 'À propos',
    'SOCIAL RESPONSIBILITY' => 'RESPONSABILITÉ SOCIALE',
    'We donate a portion of our annual proceeds to water-conservation efforts' => 'Nous soutenons des organismes qui se consacrent à la protection de l’eau',
    'Berkey Water Filters' => 'Filtres à eau Berkey
',
    'Multi-Use Berkey Systems' => 'Systèmes multi-usage',
    'Portable Berkey Systems' => 'Systèmes portatifs',
    'Fluoride Removal Filters' => 'Filtres anti-fluor
',
    'Replacement Filters' => 'Filtres de remplacement',
    'Berkey Accessories' => 'Accessoires Berkey',
    'Products' => 'Produits',
    'Vortex Water Revitalizer' => 'Revitaliseur d’eau à vortex',
    'Learning Center' => 'Ressources',
    'How Berkey Systems Work' => 'Comment fonctionne un Berkey',
    'Berkey Test Results' => 'Résultats d’analyse de laboratoire',
    'FAQ' => 'Foire aux questions',
    'Videos' => 'Vidéos',
    'User Instructions' => 'Utilisation et entretien
',
    'Tips & Troubleshooting' => 'Conseils et dépannage',
    'Berkey Warranty' => 'Garantie Berkey',
    'History of Berkey' => 'L’histoire de Berkey',
    'Why Choose Berkey' => 'Pourquoi choisir Berkey',
    'Features & Benefits' => 'Caractéristiques et avantages',
    'Cleanable Filters' => 'Filtres nettoyables',
    'Water is Important!' => 'L’eau, c’est vital!',
    'Cost Comparison' => 'Comparaison de coûts
',
    'Performance Comparison' => 'Comparaison de performance',
    'Testimonials' => 'Témoignages
',
    'Blog' => 'Blogue',
    'Delivery' => 'Livraison
',
    'Legal Notice' => 'Avis légal

',
    'Terms & Conditions' => 'Modalités d’achat',
    'Secure payment' => 'Paiements sécurisés',
    'Follow Us' => 'Suivez-nous',
    'We Accept' => 'Nous acceptons',
    'Learn More' => 'En savoir plus',
    'Use Your Berkey[1]®[/1] System Everywhere' => 'Utilisez votre Berkey[1]®[/1] partout',
    'At HOME or at WORK' => 'À la MAISON ou au BUREAU',
    'For small or large GROUPS' => 'Pour de petits ou de grands GROUPES',
    'In hospitality and catering' => 'Dans des cafés et restaurants',
    'In healthcare facilities' => 'Dans des centres de santé',
    'At the COTTAGE or CAMPING' => 'Au CHALET ou en CAMPING
',
    'During sporting and outdoor activities' => 'Lors d’activités sportives et de plein air
',
    'During foreign travel' => 'Lors de voyages à l’étranger',
    'For EMERGENCY PREPAREDNESS' => 'Pour les situations d’URGENCE
',
    'Shop Now' => 'MAGASINER',
    'Berkey[1]®[/1] is the most cost-effective water solution on the market' => 'Berkey[1]®[/1] est la solution d’eau filtrée la plus économique sur le marché',
    'Berkey[1]®[/1] COST VS. OTHER FILTERED WATERS' => ' COÛT Berkey[1]®[/1]  VS. AUTRES FILTRES',
    'Information' => 'Information',
    'Berkey[1]®[/1] Removes Harmful Contaminants From Water' => 'Berkey[1]®[/1] retire les contaminants nocifs
présents dans l’eau de l’aqueduc',
    'Chlorine, THM’s, and other harmful derivatives' => 'Le chlore, les trihalométhanes et autres dérivés',
    'Chemicals, PHARMACEUTICALS, hormones' => 'Les produits chimiques et PHARMACEUTIQUES
',
    'Pesticides & agricultural run-off' => 'Les pesticides et autres résidus agricoles
',
    'HEAVY METALS (lead, mercury, chromium, etc.)' => 'Les MÉTAUX LOURDS (plomb, mercure, chrome, etc.)
',
    'Volatile Organic Compouds (VOC’s)' => 'Les composés organiques volatils (COV)
',
    'Petroleum products' => 'Les produits pétroliers
',
    'FLUORIDE (when ftted with PF-2 post-flters)' => 'Le FLUOR (avec post-filtres PF-2)',
    'Unit Cost (aprox)' => 'Coût unitaire (approx)',
    'Cost per liter' => 'Coût par litre',
    'Berkey[1]®[/1] COST VS. BOTTLED WATERS' => 'COÛT  Berkey[1]®[/1] VS. EAU EMBOUTEILLÉE',
    'Never Run Out of SAFE, PURE Drinking Water' => 'Transformez l’eau non-potable en eau potable',
    'Berkey® removes 99.9999% of BACTERIA and VIRUSES' => 'Berkey® retire 99,9999% des BACTÉRIES et VIRUS
',
    'Use with untreated water (wells, lakes, rivers)' => 'Traitez toute source d’eau non-potable (puits, lacs, rivières)
',
    'Stop carrying water to the cottage' => 'Cessez d’avoir à transporter de l’eau potable au chalet
',
    'Use during BOIL WATER ADVISORIES' => 'Utilisez votre Berkey® lors d’AVIS D’ÉBULLITION
',
    'Be ready for environmental & natural disasters' => 'Soyez prêts en cas d’urgence environnementale
',
    'Use a portable Berkey® abroad with unsafe water sources' => 'Utilisez un Berkey® portatif à l’étranger pour les sources d’eau incertaines',
    'Reduce Your Environmental Footprint' => 'Réduisez votre empreinte environnementale',
    'Berkey[1]®[/1] Water Helps Keep Your Body in Balance' => 'L’eau Berkey[1]®[/1] contribue à l’équilibre 
interne du corps
',
    'Berkey® purifiers produce BALANCED pH water of 7' => 'Un Berkey® produit de l’eau avec un pH ÉQUILIBRÉ DE 7',
    'The pH of Reverse Osmosis water is 5, which is 100 times more acidic than our body’s balanced pH' => 'Au contraire, l’eau osmosée a un pH très acide de 5, soit 100 fois plus acide que le pH de notre corps
',
    'Berkey® systems KEEP MINERALS IN THE WATER' => 'Un purificateur Berkey® retire les contaminants nocifs mais PRÉSERVE LES MINÉRAUX
',
    'Reverse Osmosis water and distilled water are demineralized and leach essential minerals from our body' => 'Au contraire, l’eau osmosée est déminéralisée et dérobe les minéraux essentiels à notre corps',
    'The clean and REFRESHING TASTE of Berkey® water will make you want to DRINK MORE WATER' => 'La douceur de l’eau Berkey® donne envie de boire plus d’eau',
    'Vortex your Berkey® water for even greater health benefits' => 'Une eau Berkey® revitalisée avec un système à vortex offre encore plus de BIENFAITS POUR LA SANTÉ',
    'Berkeys® are Easy to Use and Maintain' => 'Berkeys® est facile à utiliser et à entretenir',
    'Quick and easy to set up' => 'Assemblage et amorçage SIMPLE et SANS OUTILS
',
    'No plumbing nor electricity required' => 'Aucun raccordement à la plomberie ni à l’électricité
',
    'Filters can be EASILY CLEANED using a scouring pad and running water when flow rate decreases' => 'Les FILTRES SE NETTOIENT à l’aide d’un tampon à récurer, sous l’eau courante, lorsque le débit d’écoulement ralentit
',
    'Well maintained Black Berkey® flters LAST FOR YEARS' => 'Avec un entretien régulier, les filtres Black Berkey® peuvent DURER DE NOMBREUSES ANNÉES',
    'Fluoride post-flters must be changed every 1000 gallons (4000 liters)S' => 'Les filtres de fluor se remplacent tous les 4000 litres
',
    'Stainless steel components can be cleaned with a soft sponge, dishsoap and water.' => 'Les réservoirs en acier inoxydable se nettoient avec une éponge, du savon à vaisselle et de l’eau.',
    'on Berkey® Systems' => 'sur les systèmes Berkey® ',
    'Call the water experts toll free' => 'APPELEZ LES EXPERTS DE L’EAU',
    'Email Us' => 'Courriel',
    'Need Help Choosing your Berkey? Click Here' => 'Comment choisir votre Berkey? Cliquez ici',
    'Shop for Replacement Filters' => 'Magasinez vos filtres de remplacement',
    'Transform your Berkey Water into Living Alkaline Water' => 'Transformez votre eau Berkey®  en eau alcaline revitalisée',
    '[1] SIGN UP TO OUR MAILING LIST[/1] to receive exclusive offers, testimonials, health information, and more...' => '[1] ABONNEZ-VOUS À NOTRE INFOLETTRE[/1] pour recevoir des offres exclusives, des témoignages, des conseils et plus...',
    'Orders ship from Canada. No hidden shipping or import fees' => 'Les commandes sont expédiées à partir du Canada - aucuns frais cachés',
    '$300+' => '300 $+',
    '1.4¢/liter' => ' 1,4¢/litre',
    '$30' => '30 $',
    '4.1¢/liter' => '4,1¢/litre',
    ...
    '$200' => '200 $',
    '4.0¢/liter' => '4,0¢/litre',
    '2 Black Berkey® Elements can treat up to 6000 gallons (22,700 liters) of water. That’s the equivalent of 150 Brita filters that won’t end up in the landfill.' => '2 Black Berkey® peuvent traiter 22 700 litres d’eau, ce qui équivaut
  par exemple à 150 filtres Brita qui n’iront pas à la poubelle',
    'Durable stainless steel reservoirs will last a lifetime and will never leach harmful chemicals into water' => 'Les réservoirs durables en acier inoxydable éliminent la migration  vers l’eau de produits chimiques associés au plastique',
    'No tools required' => ' ',
    '18 Liters' => '18 Litres',
    '$5' => '5 $',
    '28¢/liter' => '28¢/litre',
    '$2' => '2 $',
    '50¢/liter' => '50¢/litre',
    '24 x 500ml' => '24 x 500ml',
    '$4' => '4 $',
    '33¢/liter' => '33¢/litre',
    '4 Liters' => '4 Litres',
    'E-commerce Development Agency:' => 'Agence Web en commerce électronique:',
    'Free Shipping' => 'Livraison gratuite',
    'Send Us a [1]Message[/1]' => 'Envoyez-nous [1]un message[/1]',
    'Send Us a Message' => 'Envoyez-nous un message',
    'Send Us a Message:' => 'Envoyez-nous un message :',
    'All rights reserved' => 'Tous les droits sont réservés',
    'An earth-friendly alternative to bottled water' => 'Optez pour une solution plus écologique que l’eau embouteillée',
    'Reduce plastic waste and greenhouse gases' => 'Éliminez les bouteilles de plastique',
    'Eliminate water wastage associated with the bottled water industry' => 'Réduisez les gaz à effet de serre et le gaspillage d’eau',
    'How to choose my Berkey?' => 'Comment choisir mon Berkey?',
    'Multi-Use Systems' => 'Systèmes multi-usage',
    'Portable Systems' => 'Systèmes portatifs',
    'Vortex Water Revitalizers' => 'Revitaliseurs d’eau à vortex',
    'Features and Benefits' => 'Caractéristiques et avantages',
    'Water Types Comparison' => 'Comparaison de types d’eau',
    'Environmentally Friendly' => 'Solution écologique',
    'pH Balanced Healthful Water' => 'Eau au pH équilibré',
    'Travel & Emergency Preparedness' => 'Voyages et urgences',
    'How Do Berkey Systems Work?' => 'Comment fonctionne un Berkey?',
    'Independent Lab Test Results' => 'Résultats d’analyse de laboratoire',
    'FAQ & Troubleshooting' => 'FAQ et dépannage',
    'Warranty Information' => 'Garantie Berkey',
    'Terms & Conditions of Sale' => 'Modalités d’achat
',
    'Shipping & Returns' => 'Livraison et échanges
',
    'Privacy Policy' => 'Politique de confidentialité
',
    'FLUORIDE (when fitted with PF-2 post-flters)' => 'Le FLUOR (avec post-filtres PF-2)',
    'Berkey® removes 99.9[1] of BACTERIA and VIRUSES' => 'Berkey® retire 99,9[1] des BACTÉRIES et VIRUS',
    'Berkeys[1]®[/1] are Easy to Use and Maintain' => 'Berkey[1]®[/1] est facile à utiliser et à entretenir',
    'Fluoride post-flters must be changed every 1000 gallons (4000 liters)' => 'Les filtres de fluor se remplacent tous les 4000 litres',
    'Transform your Berkey Water [1] into Living Alkaline Water' => 'Transformez votre eau Berkey® [1] en eau alcaline revitalisée',
    'Need Help Choosing your Berkey? [1]Click Here' => 'Comment choisir votre Berkey?® [1]Cliquez ici',
    'Orders ship from Canada. [1] No hidden shipping or import fees' => 'Les commandes sont expédiées à [1]
partir du Canada - aucuns frais cachés',
    'Need Help Choosing your Berkey®? [1]Click Here' => 'Comment choisir votre Berkey®? [1]Cliquez ici',
    'Transform your Berkey® Water [1] into Living Alkaline Water' => 'Transformez votre eau Berkey®  [1]en eau alcaline revitalisée',
    'We offer free shipping on all new[1] Berkey Systems' => 'Nous offrons la livraison gratuite[1] sur tous les systèmes Berkey®',
    'We offer free shipping on all new[1] Berkey® Systems' => 'Nous offrons la livraison gratuite[1] sur tous les systèmes Berkey®',
    'We have been providing healthy water[1] solutions to Canadians since 2010' => 'Nous sommes reconnus pour notre [1] expertise en matière d’eau et de santé',
    'We donate a portion of our annual[1] proceeds to water-conservation efforts' => 'Nous soutenons des organismes qui se [1]consacrent à la protection de l’eau
',
    'Shop for Replacement Filters[1]' => 'Magasinez[1] vos filtres de remplacement',
    'Aqua Health Products Inc.' => 'Produits Aqua Santé Inc.',
  ...
  array (
    'BERKEY SYSTEMS' => 'SYSTÈMES BERKEY',
  ...
  array (
    ...
    'Do You Know What’s In Your Water?' => 'Savez-vous ce qui se retrouve dans votre eau ?',
    'Depending on where you live and where your tap water comes from, you may have some or most of these contaminants in your
        drinking water' => 'Selon l’endroit où vous habitez et la source de votre eau, vous avez fort probablement plusieurs de ces contaminants dans votre eau de consommation. 
',
    'Chlorine' => 'Chlore',
    'Fluoride' => 'Fluor',
    'Bacteria' => 'Bactéries',
    ...
    'Bad Taste & Odours' => 'Odeurs et mauvais goûts',
    'Pesticides' => 'Pesticides',
    'Pharmaceuticals' => 'Hormones et antibiotiques',
    'VOC’s' => 'COV',
    'Chemicals' => 'Produits chimiques',
    'Petroleum Products' => 'Produits pétroliers',
    'SHOP NOW' => 'MAGASINER ',
    'LEARN MORE' => 'EN SAVOIR PLUS',
    'OTHER BERKEY ACCESSORIES' => 'AUTRES ACCESSOIRES BERKEY',
    'SEE ALL OUR BERKEY ACCESSORIES' => 'VOIR TOUS NOS ACCESSOIRES BERKEY',
    'OUR BEST SELLERS' => 'NOS MEILLEURS VENDEURS',
    'Depending on where you live and where your tap water comes from, you may have some or most of these contaminants in your drinking water' => 'Selon l’endroit où vous habitez et la source de votre eau, vous avez fort probablement plusieurs de ces contaminants dans votre eau de consommation. ',
    'SEE ALL OUR BERKEY SYSTEMS' => 'VOIR TOUS NOS SYSTÈMES BERKEY',
    'second line' => 'Les systmes Berkey peuvent retirer jusqua 99,9999 de ces contaminants.',
    'Find out how Berkey Systems can eliminate up to 99.9999[1] of harmful contaminants found in water.' => 'Les systèmes Berkey® peuvent retirer jusqu’à 99,9[1] de ces contaminants.  Informez-vous!',
    'Videos' => 'Vidéos',
    'Depending on where you live and where your tap water comes from, you may have some or most of these contaminants in your drinking water.' => 'Selon l’endroit où vous habitez et la source de votre eau, vous avez fort probablement plusieurs de ces contaminants dans votre eau de consommation.',
  ...
  'ShopThemeCart' => 
  array (
    'Total (tax excl.)' => 'Total (avant taxes)',
  ),
  ...
  array (
    ...
    'You can reset your password every %d minute(s) only. Please try again later.' => 'Vous pouvez réinitialiser votre mot de passe toutes les %d minute(s) seulement. Veuillez réessayer ultérieurement.',
  ...
  array (
    ...
    'Cannot write language file for email subjects. Path is: %s' => 'Impossible d\'écrire dans le fichier de langue pour les sujets des courriels : "%s"',
...
Thanks for your patience.' => 'Notre boutique est en cours de mise à jour, nous revenons rapidement ! Merci pour votre patience.',
  ...
  array (
    ...
    'Employee Edition' => 'Édition des employés',
    'Values' => 'Valeurs',
    'Value' => 'Valeur',
    'Color' => 'Couleur',
  ...
  array (
    ...
    'Gross margin expressed in percentage assesses how cost-effectively you sell your goods. Out of $100, you will retain $%s to cover profit and expenses.' => 'Le taux de marge permet d\'évaluer la rentabilité de la vente d\'un produit. Pour 100$, vous garderez %s$ pour couvrir vos dépenses et votre bénéfice.',
...
<br />- Donner les droits d\'écriture du fichier créé (CHMOD 666 sur les systèmes Unix).',
    ...
    'Advanced stock management has incorrect value. Not set for product %1$s ' => 'La gestion des stocks avancée a une valeur incorrecte. Pas configuré pour le produit %1$s ',
    'Advanced stock management is not enabled, cannot enable on product %1$s ' => 'La gestion de stock avancée n\'est pas activée globalement, impossible donc de l\'activer pour le produit %1$s ',
    'Advanced stock management is not enabled, warehouse not set on product %1$s ' => 'La gestion de stock avancée n\'est pas activée, aucun entrepôt n\'a donc été associé au produit %1$s ',
    ...
    '"%s" is not a valid email address.' => '"%s" n\'est pas une adresse courriel valide.',
