<?php /* Smarty version Smarty-3.1.19, created on 2018-05-29 05:54:22
         compiled from "modules/productcomments//productcomments.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17502229665b0d4d7e29e977-52746006%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '994f620f4d8e9afbcd635917918d137eacf614b9' => 
    array (
  ...
  'nocache_hash' => '17502229665b0d4d7e29e977-52746006',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b0d4d7e32ed35_09090586',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b0d4d7e32ed35_09090586')) {function content_5b0d4d7e32ed35_09090586($_smarty_tpl) {?>
    ...
    <div class="tabs">
        <div class="clearfix pull-right">
            <?php if (($_smarty_tpl->tpl_vars['too_early']->value==false&&($_smarty_tpl->tpl_vars['logged']->value||$_smarty_tpl->tpl_vars['allow_guests']->value))) {?>
                ...
                <?php } else { ?>
                <a class="open-comment-form btn btn-primary" href="	<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['urls']->value['pages']['authentication'], ENT_QUOTES, 'UTF-8');?>
                    ...
                    <?php if (isset($_smarty_tpl->tpl_vars['product']->value)&&$_smarty_tpl->tpl_vars['product']->value) {?>
                        <div class="product clearfix">
                            <div class="product_desc">
                                <p class="product_name"><strong><?php if (isset($_smarty_tpl->tpl_vars['product']->value->name)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8');?>
<?php } elseif (isset($_smarty_tpl->tpl_vars['product']->value['name'])) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8');?>
<?php }?></strong></p>
...
<?php } elseif (isset($_smarty_tpl->tpl_vars['product']->value['description_short'])) {?><?php echo $_smarty_tpl->tpl_vars['product']->value['description_short'];?>
<?php }?>
                            </div>
                        </div>
                    <?php }?>
