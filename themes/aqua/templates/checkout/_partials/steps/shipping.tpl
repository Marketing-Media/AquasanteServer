  ...
  <div class="delivery-options-list">
    {if $delivery_options|count}
      ...
      >
            ...
            <div class="delivery-options">
              {foreach from=$delivery_options item=carrier key=carrier_id}
                  <div class="row delivery-option">
                    ...
                    <label for="delivery_option_{$carrier.id}" class="col-sm-11 col-10 delivery-option-2">
                      <div class="row">
        ...
        <button type="submit" class="continue btn btn-third  float-right" name="confirmDeliveryOption" value="1">
