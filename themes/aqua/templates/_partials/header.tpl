  ...
  <div id="logorow" class=" grid">
      ...
      <a class="logo" href="{$urls.base_url}" title="{$shop.name}">
        ...
        <div class="experts">
          ...
          <a href="tel:18774112782"><div class="text-uppercase bsecundary subtitle"><i class="fas fa-phone" data-fa-transform="flip-h"></i> {l s='[1]1-877-411-AQUA[/1]  (1-877-411-2782)' d='Shop.Theme.Global' sprintf=['[1]' => '<strong>','[/1]' => '</strong>']}</div></a>
          <div class="contact">
            <ul class="d-flex justify-content-center contactus">
              ...
              <li class="bthird"><i class="icon fab fa-facebook-messenger"></i><a href="https://m.me/aquaberkeyfilters" target="_blank">{l s='Messenger' d='Shop.Theme.Global'}</a></li>
            </ul>
          </div>
        </div>
