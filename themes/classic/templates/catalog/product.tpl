  ...
  <section id="main" class="grid" itemscope itemtype="https://schema.org/Product">
    ...
    <section class="product-accessories clearfix">
      ...
      <div class="products">
        ...
        {/block}
        {/foreach}
        <a href="{url entity='category' id=$category->id}" class="btn btn-outline-secondary btn-sm">{l s='SEE ALL OUR BERKEY ACCESSORIES' d='Shop.Theme.Catalog'} <i class="far fa-chevron-right"></i></a>
      </div>
    </section>
    {/if}
    {hook h='displayFooterAccesories' product=$product category=$category}
