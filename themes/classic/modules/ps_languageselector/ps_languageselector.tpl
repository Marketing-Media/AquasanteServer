 ...
 *}
  ...
  <div class="language-selector-wrapper">
    <span id="language-selector-label" class="hidden-md-up d-none d-sm-block d-md-none">{l s='Language:' d='Shop.Theme.Global'}</span>
    <div class="language-selector dropdown js-dropdown">
      ...
      <select class="link hidden-md-up d-sm-block d-md-none" aria-labelledby="language-selector-label">
        {foreach from=$languages item=language}
