			...
			$.ajax({
				...
				success: function(response) {
					if (!response.hasError) {
						...
						alert('ERROR: unable to delete the card info: '+response.error);
					}
				},
				error: function(response) {
					alert('ERROR: unable to delete the card info');
				}
			})
		})
	});
...
<fieldset id="invoice_block">
	<legend><img src="{$cc_path|escape:'htmlall':'UTF-8'}logo.gif"/> {l s='Card payment information' mod='creditcardofflinepayment'}</legend>
	<p style="float:right;">
