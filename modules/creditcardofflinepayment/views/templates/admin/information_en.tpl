	...
	<div class="panel-footer">
		<div class="row">
				<div class="col-lg-6 developers">
					...
					<a target="_blank" href="http://addons.prestashop.com/en/109_idnovate"><img src="{$this_path|escape:'htmlall':'UTF-8'}views/img/information/logo_idnovate.png" /></a><br /><br />
				</div>
				<div class="col-lg-6 partnership">
					<p>We are PrestaShop partners!</p>
					<a target="_blank" href="https://www.prestashop.com/en/web-agency-partners/bronze/idnovate"><img src="{$this_path|escape:'htmlall':'UTF-8'}views/img/information/ps-bronze.png" /></a>
				</div>
			</div>
