		...
		<div class="form-group">
			<div class="row">
				<div class="col-lg-4 util-links">
					<p>
						<i class="icon-star"></i> <a target="_blank" title="Rate this module" href="http://addons.prestashop.com/es/ratings.php">¿Te parece útil el módulo? Qué te parece si nos dejas tu valoración en Addons?</a><br/><br/>
											...
											<div class="row">
												<div class="col-xs-12">
													<div class="col-xs-2 col-lg-3 module-image">
														<img src="{$this_path|escape:'htmlall':'UTF-8'}views/img/information/{$modules[$counter|escape:'htmlall':'UTF-8']['icon']|escape:'htmlall':'UTF-8'}" />
													</div>
	...
	<div class="panel-footer">
		<div class="row">
				<div class="col-lg-6 developers">
					...
					<a target="_blank" href="http://addons.prestashop.com/es/109_idnovate"><img src="{$this_path|escape:'htmlall':'UTF-8'}views/img/information/logo_idnovate.png" /></a><br /><br />
				</div>
				<div class="col-lg-6 partnership">
					<p>¡Somos Partners PrestaShop!</p>
					<a target="_blank" href="https://www.prestashop.com/es/asociados-agencia-web/bronce/idnovate"><img src="{$this_path|escape:'htmlall':'UTF-8'}views/img/information/ps-bronze.png" /></a>
				</div>
			</div>
