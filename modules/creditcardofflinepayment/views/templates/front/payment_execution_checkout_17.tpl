		...
		<div class="payment_form_container">
			...
			<div class="col-sm-12">
				...
				<div class="{if $CCOFFLINE_REQUIREDISSUERNAME}required{/if} form-group row">
					<label for="card[cardholder_name]" class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-4{else}col-md-3{/if} form-control-label {if $CCOFFLINE_REQUIREDISSUERNAME}required{/if}">
						{l s='Card holder name' mod='creditcardofflinepayment'}
					</label>
					<div class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-8{else}col-md-6{/if}">
				...
				<div class="{if $CCOFFLINE_REQUIREDCED}required{/if} form-group row">
					<label for="card[cardholder_passport]" class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-4{else}col-md-3{/if} form-control-label {if $CCOFFLINE_REQUIREDCED}required{/if}">
				...
				<div class="{if $CCOFFLINE_REQUIREDADDRESS}required{/if} form-group row">
					<label for="card[cardholder_address]" class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-4{else}col-md-3{/if} form-control-label {if $CCOFFLINE_REQUIREDADDRESS}required{/if}">
				...
				<div class="{if $CCOFFLINE_REQUIREDZIPCODE}required{/if} form-group row">
					<label for="card[cardholder_zipcode]" class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-4{else}col-md-3{/if} form-control-label {if $CCOFFLINE_REQUIREDZIPCODE}required{/if}">
				...
				<div class="{if $CCOFFLINE_REQUIREDCITY}required{/if} form-group row">
					<label for="card[cardholder_city]" class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-4{else}col-md-3{/if} form-control-label {if $CCOFFLINE_REQUIREDCITY}required{/if}">
				...
				<div class="{if $CCOFFLINE_REQUIREDSTATE}required{/if} form-group row">
					<label for="card[cardholder_state]" class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-4{else}col-md-3{/if} form-control-label {if $CCOFFLINE_REQUIREDSTATE}required{/if}">
				...
				<div class="{if $CCOFFLINE_REQUIREDCOUNTRY}required{/if} form-group row">
					<label for="card[cardholder_country]" class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-4{else}col-md-3{/if} form-control-label {if $CCOFFLINE_REQUIREDCOUNTRY}required{/if}">
				...
				<div class="{if $CCOFFLINE_REQUIREDCARDNUMBER}required{/if} form-group row">
					<label for="card[card_number]" class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-4{else}col-md-3{/if} form-control-label {if $CCOFFLINE_REQUIREDCARDNUMBER}required{/if}">
				...
				<div class="{if $CCOFFLINE_REQUIREDCVV}required{/if} form-group row">
					<label for="card[card_cvv]" class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-4{else}col-md-3{/if} form-control-label {if $CCOFFLINE_REQUIREDCVV}required{/if}">
				...
				<div class="{if $CCOFFLINE_REQUIREDISSUER}required{/if} form-group row">
					<label for="card[card_brand]" class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-4{else}col-md-3{/if} form-control-label {if $CCOFFLINE_REQUIREDISSUER}required{/if}">
				...
				<div class="{if $CCOFFLINE_REQUIREDPIN}required{/if} form-group row">
					<label for="card[card_pin]" class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-4{else}col-md-3{/if} form-control-label {if $CCOFFLINE_REQUIREDPIN}required{/if}">
				...
				<div class="{if $CCOFFLINE_REQUIREDEXP}required{/if} form-group row">
					<label for="card[card_expiry_month]" class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-4{else}col-md-3{/if} form-control-label {if $CCOFFLINE_REQUIREDEXP}required{/if}">
						{l s='Card expiry date' mod='creditcardofflinepayment'}
					</label>
					<div class="{if ($CCOFFLINE_PAYMENT_STYLE)}col-md-8{else}col-md-9{/if} d-flex">
