...
{if $items}
	...
	<div class="item-list {$settings.display_type|escape:'html':'UTF-8'}{if $col} row{/if}{if $resource_type == 'category' && empty($settings.cat_cover)} no-images{/if}">
	{$item_tpl_path = $blog->getListItemTplPath($resource_type)}
