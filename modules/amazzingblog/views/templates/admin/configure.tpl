...
<div class="bootstrap amazzingblog clearfix{if empty($blog->general_settings.user_comments)} no-comments{/if}">
	<div class="menu-panel col-lg-2 col-md-3">
		<div class="list-group">
			...
			<a href="#imgtypes" class="list-group-item"><i class="icon-image"></i> {l s='Thumbnail sizes' mod='amazzingblog'}</a>
			...
			{foreach $settings_types as $identifier => $type_name}
				<a href="#{$identifier|escape:'html':'UTF-8'}_settings" class="list-group-item sub-item settings{if $identifier == 'comment'} user-comments{/if}">
	...
	<div class="panel col-lg-10 col-md-9">
		...
		{/foreach}
		<div id="imgtypes" class="tab-content"  data-resource="ImgTypes">
			<h3 class="panel-title"><span class="text">{l s='Thumbnail sizes' mod='amazzingblog'}</span></h3>
			{include file="./img-types.tpl"}
		</div>
