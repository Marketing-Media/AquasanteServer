...
class ProductCore extends ObjectModel
{
    ...
    /** @var string Videos on Product Page */
    public $video;
    ...
    */
    public static function getNewProducts($id_lang, $page_number = 0, $nb_products = 10, $count = false, $order_by = null, $order_way = null, Context $context = null)
    {
        ...
        $sql = new DbQuery();
        $sql->select(
            'p.*, product_shop.*, stock.out_of_stock, IFNULL(stock.quantity, 0) as quantity, pl.`description`, pl.`video`, pl.`description_short`, pl.`link_rewrite`, pl.`meta_description`,
